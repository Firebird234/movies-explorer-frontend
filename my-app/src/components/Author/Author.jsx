        ...
        <section className="author">
            ...
            <div className="author__container">
                <div className="author__text-container">
                    ...
                    <a href="https://forums.macrumors.com/threads/facebook-is-for-loosers.597172/" className="author__link" target = '_blank'>Facebook</a>
                    <a href="https://github.com/Firebird234/movies-explorer-frontend" className="author__link" target = '_blank'>Github</a>
                    </div>
                </div>
            ...
            <div className="author__portfolio">
                ...
                <a target = '_blank' href="https://firebird234.github.io" className="author__portfolio-item">
